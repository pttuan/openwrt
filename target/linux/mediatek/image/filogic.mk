...
define Device/tplink_be805-v1
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := kmod-leds-lp5523 kmod-phy-aquantia kmod-usb3 kmod-mt7996-firmware mt7988-wo-firmware
  IMAGE_SIZE := 40960k
  KERNEL_IN_UBI := 1
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  ...
  ARTIFACT/second-u-boot.bin := mt7988-uboot-raw tplink_be805-v1 | gzip | \
